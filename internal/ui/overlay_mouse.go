...
// filter builder and the JQL search. A click on a row picks it, outside
// the box closes, as their esc would.
...
func (m *Model) jqlOnTop() bool {
	return m.jql != nil && m.settings == nil && m.filterBuilder == nil && m.descEdit == nil && !m.helpOpen
}
