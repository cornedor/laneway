...
var keyScopes = []struct {
	...
	{"board", []string{
		...
		"next_view", "prev_view", "toggle_mode", "sort", "move_sprint", "assignee_filter", "mine", "clear_filters", "roadmap", "palette", "mark", "bulk", "plan", "charts", "timer", "timesheet", "inbox", "site", "standup",
	}},
	{"panel", []string{
		...
		"log_work", "timer", "timesheet", "description", "inbox", "issue_actions", "standup",
	}},
}
