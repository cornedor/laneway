...
func (k *keyMap) keyNames() map[string]*key.Binding {
	return map[string]*key.Binding{
		...
		"assignee_filter": &k.Assignee, "mine": &k.Mine, "clear_filters": &k.ClearFilters, "roadmap": &k.Roadmap, "palette": &k.Palette, "mark": &k.Mark, "bulk": &k.Bulk, "plan": &k.Plan, "charts": &k.Charts, "log_work": &k.LogWork, "description": &k.JiraDescription, "inbox": &k.Inbox, "timer": &k.Timer, "timesheet": &k.Timesheet,
	}
}
...
var keyScopes = []struct {
	...
	{"panel", []string{
		...
		"log_work", "timer", "timesheet", "description", "inbox",
	}},
}
