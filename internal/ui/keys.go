...
func (k *keyMap) keyNames() map[string]*key.Binding {
	return map[string]*key.Binding{
		...
		"assignee_filter": &k.Assignee, "mine": &k.Mine, "clear_filters": &k.ClearFilters, "roadmap": &k.Roadmap, "palette": &k.Palette, "mark": &k.Mark, "bulk": &k.Bulk,
	}
}
...
var keyScopes = []struct {
	...
	{"board", []string{
		...
		"next_view", "prev_view", "toggle_mode", "sort", "move_sprint", "assignee_filter", "mine", "clear_filters", "roadmap", "palette", "mark", "bulk",
	}},
	{"panel", []string{
