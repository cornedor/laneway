...
var keyScopes = []struct {
	...
	{"board", []string{
		...
		"next_view", "prev_view", "toggle_mode", "sort", "move_sprint", "assignee_filter", "mine", "clear_filters", "roadmap", "palette", "mark", "mark_all", "undo", "bulk", "plan", "charts", "timer", "timesheet", "inbox", "site", "standup", "jql", "pin", "fold", "unfold_all", "settings", "filter_builder", "panel_wider", "panel_narrower", "quick_edit",
	}},
	{"panel", []string{
