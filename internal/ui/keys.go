...
func (k *keyMap) keyNames() map[string]*key.Binding {
	return map[string]*key.Binding{
		...
		"assignee_filter": &k.Assignee, "mine": &k.Mine, "clear_filters": &k.ClearFilters, "roadmap": &k.Roadmap, "palette": &k.Palette, "mark": &k.Mark, "bulk": &k.Bulk, "plan": &k.Plan, "charts": &k.Charts, "log_work": &k.LogWork, "description": &k.JiraDescription, "inbox": &k.Inbox, "issue_actions": &k.IssueActions, "site": &k.Site, "timer": &k.Timer, "timesheet": &k.Timesheet,
	}
}
...
var keyScopes = []struct {
	...
	{"board", []string{
		...
		"next_view", "prev_view", "toggle_mode", "sort", "move_sprint", "assignee_filter", "mine", "clear_filters", "roadmap", "palette", "mark", "bulk", "plan", "charts", "timer", "timesheet", "inbox", "site",
	}},
	{"panel", []string{
		...
		"log_work", "timer", "timesheet", "description", "inbox", "issue_actions",
	}},
}
